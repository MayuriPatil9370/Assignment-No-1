...
namespace SGM_Student_Mgt_System_04
{
    public partial class frm_Add_New_Course : Form
    {
        ...
        int Auto_Incr()
        {
            ...
            Cmd.Connection = Con;
            Cmd.CommandText = "Select Count(Course_ID) from tb_Course";
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlDataAdapter sda = new SqlDataAdapter("Insert Into tb_Course Values (" + tb_Course_ID.Text + ",'" + tb_Course_Name.Text + "')", Con);
