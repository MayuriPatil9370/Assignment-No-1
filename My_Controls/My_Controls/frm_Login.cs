...
namespace My_Controls
{
    public partial class frm_Login : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=.\SQLEXPRESS;Initial Catalog=My_Controls_DB;Integrated Security=True");
        void Con_Open()
        {
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            if (Cnt > 0)
            {
               ...
               frm_My_Controls Obj = new frm_My_Controls();
                Obj.Show();
                this.Hide();
            }
            else
            {
                ...
                lbl_Error.ForeColor = Color.DarkBlue;
            }
            tb_Username.Clear();
            tb_Password.Clear();
